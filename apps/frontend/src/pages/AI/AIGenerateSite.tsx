  ...
  <div className="ai-studio-result" style={result?.imageUrl ? { padding: 0 } : {}}>
    {result?.imageUrl ? (
      <div style={{ width: '100%', display: 'flex', flexDirection: 'column' }}>
        <img src={result.imageUrl} alt="Generated Site Preview" style={{ width: '100%', borderRadius: '12px 12px 0 0', objectFit: 'cover' }} />
        <div style={{ padding: 20 }}>
          <div className="ai-studio-result-title">Website Generated by Stitch!</div>
          <div style={{ display: 'flex', gap: 12, marginTop: 16 }}>
            <a href={result.htmlUrl} target="_blank" rel="noreferrer" style={{ textDecoration: 'none' }}>
              <button className="ai-studio-result-btn" style={{ background: '#30A46C', borderColor: '#30A46C' }}>View Live HTML</button>
            </a>
            <button className="ai-studio-result-btn" onClick={onViewSites}>Import to Editor</button>
          </div>
        </div>
      </div>
    ) : (
